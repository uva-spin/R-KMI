...
###################################################################################################################################
        if (epoch==(epochs-1)):
            ...
            cff_results = pd.DataFrame(predictions_resultss, columns = ['ReH_results', 'ReE_results', 'ReHt_results', 'dvcs_results'])
            
            cff_results.to_csv('phiidvcs_data.csv', mode='a', index=False, header=False)
