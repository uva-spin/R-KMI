...
class BKM_DVCS(object):
    ...
    @tf.function
    def total_xs(self, kins, pars, twist, dvcs_option):
...
bkm = BKM_DVCS()
xs = bkm.total_xs(tf.constant([[5.75, 1.84, 0.343, -0.172, 0]]), tf.constant([[1., 1., 1., 1., 2., 0., 0., -1.]]), "t2_ww", 'constant')
print('total xs: ', xs)
# ee, y, xi, Gamma, tmin, Ktilde_10, K = bkm.SetKinematics(1.84, 0.343, -0.172, 5.75)
# xsdvcs = bkm.DVCS(1.84, 0.343, -0.172, 0, ee, y, K, Gamma, 1., 1., 1., 1., 2., 0., 0., -1., 0)   # Pure DVCS cross-section
